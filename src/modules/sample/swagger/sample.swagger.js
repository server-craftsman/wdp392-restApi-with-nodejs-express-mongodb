 ...
 *   post:
 *     summary: Add a sample to an existing appointment
 *     tags: [samples]
 *     security:
 *       - Bearer: []
 *     requestBody:
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/AddSampleDto'
 *     responses:
 *       201:
 ...
 *                 message:
 *                   type: string
 *                   example: "Sample added to appointment successfully"
 *       400:
 ...
 *                 message:
 *                   type: string
 *                   example: "You are not authorized to add samples to this appointment"
 *                 error:
 *                   type: string
 *                   example: "Forbidden"
 *                 statusCode:
